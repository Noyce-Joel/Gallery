...
export default function Nav({
  ...
  //   return (
  //     <div
  //       className={`flex grow flex-col gap-y-5 overflow-y-auto color-black ${textColor} w-[225px] pr-6 `}
  //     >
  //       <div className={`flex h-16 shrink-0 gap-2 p-6 `}>
  //       <h1 className={`flex font-bold whitespace-nowrap tracking-wider ${textColor}`} >
  //         Noyce Photos
  //       </h1>
  //       </div>
  ...
  //           </li>
  //           <li>
  //             <div className={`text-xs font-semibold leading-6 ${textColor} flex gap-x-3 pl-7`}>
  //               Albums
  //             </div>
  ...
  return (
    <div
    className={`flex flex-col gap-y-5 color-black ${textColor} w-[225px] pr-6 `}
  >
    <div className={`flex h-16 shrink-0 gap-2 p-6 `}>
    <h1 className={`flex font-bold whitespace-nowrap tracking-wider ${textColor}`} >
      Noyce Photos
    ...
    <nav className="flex flex-1 flex-col">
      <ul role="list" className="flex flex-1 flex-col gap-y-7">
        ...
        <li className="flex flex-col grow overflow-y-auto h-auto">
          <div className={`text-xs font-semibold leading-6 ${textColor} flex gap-x-3 pl-9`}>
            Albums
          </div>
